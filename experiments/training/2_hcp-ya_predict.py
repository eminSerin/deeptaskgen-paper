...
WORKING_DIR = op.realpath(op.join(ABS_PATH, f"experiments/training/results/unetminimal_{EPOCHS}_{LR}"))
...
args = [
    ...
    f"--test_list={op.realpath(op.join(ABS_PATH, 'experiments/training/data/hcp_test_ids.txt'))}",
